...
- 각 섹션 사이에 **빈 줄(줄바꿈)** 필수
- 섹션 내 문단 사이에도 줄바꿈 포함
- SQL 값 내에서 줄바꿈 문자 그대로 유지

**3. 상세 내용 분량**
- total(연간운세): 7개 섹션, **각 섹션당 최소 3문장 이상**
- 월별운세: **최소 3개 문단** (상황설명 + 재물/직업 + 건강/인간관계)

**4. 절대 금지 사항**
- ❌ 【】 대괄호 형식 사용 금지
- ❌ 모든 내용을 한 줄로 압축하는 것 금지
- ❌ 섹션들을 줄바꿈 없이 연결하는 것 금지

**올바른 예시:**
```sql
'✨ 1. 2026년 종합 운세
2026년 병오년은 변화와 도전의 해입니다. 첫 번째 문장입니다.
두 번째 문장입니다. 세 번째 문장입니다.

✨ 2. 💰 재물운과 재테크 운
재물운 첫 번째 문장입니다. 두 번째 문장입니다.
세 번째 문장입니다.'
```

**잘못된 예시 (절대 금지):**
```sql
'【종합운세개요】내용...【재물운과 재테크운】내용...【직업운과 승진운】내용...'
```
...
### 월별 운세 (jan ~ dec) - 목표: 400자 이상

각 월별 운세는 해당 월의 상세한 운세를 담습니다.

**필수 구조: 3개 문단 이상**
```
[문단1] 해당 월의 전체적인 운세 기조, 원문의 핵심 메시지 확장

[문단2] 재물운/직업운 상세 (투자, 소비, 업무 성과, 직장 내 관계)

[문단3] 건강운/인간관계 상세 (주의사항, 길방위, 행운의 색상)
```
...
### 형식 품질 (필수 확인)
- [ ] 섹션 헤더가 이모지 형식(✨)을 사용하는가?
- [ ] 【】 대괄호 형식이 사용되지 않았는가?
- [ ] 각 섹션 사이에 줄바꿈(빈 줄)이 있는가?
- [ ] total의 7개 섹션이 각각 3문장 이상인가?
- [ ] 월별 운세가 3개 문단 이상으로 구성되었는가?
- [ ] 모든 내용이 한 줄로 압축되지 않았는가?
